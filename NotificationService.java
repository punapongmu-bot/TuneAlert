...
public final class NotificationService {
    ...
    public NotificationService(List<Notifier> channels, Priority threshold) {
        ...
        if(channels==null||channels.contains(null)) throw new IllegalArgumentException("channels error");
        if(threshold==null) throw new IllegalArgumentException("threshold error");
       

        // TODO(4.2): ✗ เก็บลูกศรตรง ๆ เสี่ยง aliasing → defensive copy!
        this.channels = new ArrayList<>(channels); //copy ก่อน
        this.threshold = threshold; //=ได้เลย
    }
